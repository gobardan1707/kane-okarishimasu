...
enum class MessageType(val value: UByte) {
    ...
    PIN_VERIFICATION_REQUEST(0x23u), // Request PIN verification from responder
    PIN_VERIFICATION_RESPONSE(0x24u), // Responder sends entered PIN
    PIN_VERIFICATION_RESULT(0x25u); // Result of PIN verification (success/failure)
